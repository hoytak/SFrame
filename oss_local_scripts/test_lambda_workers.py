...
try:
    import sframe
    from sframe._scripts import _pylambda_worker
except ImportError:
    import graphlab as sframe
    from graphlab._scripts import _pylambda_worker
...
def test_pylambda_worker():
    ...
    env=sframe.sys_util.make_unity_server_env()
...
os.environ["GRAPHLAB_LAMBDA_WORKER_LOG_FILE"] = r"%(lambda_log)s"
os.environ["GRAPHLAB_CACHE_FILE_LOCATIONS"] = r"%(run_temp_dir)s"
